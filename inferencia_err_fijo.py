...
def main():
    ...
    print(f"Iniciando Inferencia ELWRYM (Error Fijo) en: {device}")

    # =========================================================================
    # ⚙️ CONFIGURACIÓN: Cambia las rutas según lo que quieras evaluar
    # =========================================================================
    
    # Ruta del modelo .pth que quieres probar
    RUTA_MODELO_PTH = r"C:\CODE2026\CASSIproy2026\CASSIproy2026\ELWRYMnet\ELWRYM_1a20\pesos_elwrym_9_bloques.pth"
    
    # Ruta exacta de la carpeta de la imagen de prueba
    ...
    # Inicializar la Red Extra-Ligera
    ...
    fig.canvas.manager.set_window_title(f'Inferencia ELWRYM ({num_bloques} Bloques) - Escala Fija')
    ...
    def update(val):
        ...
        # El mapa se actualiza con los nuevos datos, pero el límite de color se queda quieto
